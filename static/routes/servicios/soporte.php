                ...
                <div class="container mb80">
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="/SC-502-Web-ClienteServidor/static/img/servicios/soporteensitio.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <p class="custom-card-text">En caso de ser necesario uno de nuestros técnicos visitará sus instalaciones para brindar una solución inmediata.
                    </ul></p>
