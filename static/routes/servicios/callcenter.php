                ...
                <div class="container mb80">
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="/SC-502-Web-ClienteServidor/static/img/servicios/callcenter.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <p class="custom-card-text">Mediante personal altamente capacitado ofrecemos un servicio de solidez, respaldo y garantía
                        brindáandole apoyo en todas sus
                        dudas y consultas sobre procedimientos de nuestro software empresarial.
                    </ul></p>
