...
<head>
    <title>Nómina y Recursos Humanos</title>
    ...
    <main>
        <div class="content-container">
            ...
            #2069AD; text-align: center; border-bottom: 1px solid black">
                    <i class="fa-solid fa-briefcase fa-beat fa-sm" style="color: #ffffff;"></i> Nómina y Recursos Humanos
                </p>
                <div id="about-card" class="card text-center">
                    ...
                    <ul>
                        ...
                        <li>Controlar los préstamos al empleado.</li>
                        <li>Registrar permisos sobre ausencias e incapacidades.</li>
                        <li>De una forma completamente automatizada podrá elaborar el cálculo de nóminas, reportes y boletas de pago así como el cálculo de aguinaldos, control de vacaciones y liquidaciones laborales.</li>
                        <li>Control de reloj y turnos laborales.</li>
                        <li>Índices de rotación y ausentismo.</li>
                    </ul></p>
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="\SC-502-Web-ClienteServidor\static\img\productos\recursosHumanos.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <div class="card-body">
