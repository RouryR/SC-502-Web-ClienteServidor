                ...
                <div class="container mb80">
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="/SC-502-Web-ClienteServidor/static/img/servicios/capacitaciones.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <p class="custom-card-text">El software marca Excalibur-Tech S.A. brinda capacitación sobre uso de la herramienta en las
