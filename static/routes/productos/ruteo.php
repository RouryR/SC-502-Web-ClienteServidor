                                    ...
                                    <div class="zoom-effect">
                                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php"
                                            ...
                                            <p><img class="custom-image"
                                                    src="/SC-502-Web-ClienteServidor/static/img/productos/ruteo.jpg"
                                                    alt="ERP" /></p>
                                        </a>
                                    </div>
                                    <p class="custom-card-text">Con esta herramienta usted podrá mediante el uso de
                                        herramientas como celulares, netbooks, portátiles o tablets en la plataforma
                                        android, realizar procesos de facturación Directa y Pre Venta, administrando
                                        rutas de venta, reparto y cobro según sea su necesidad empresarial. Tendrá
                                        acceso a la información tanto en su empresa como en la ruta en tiempo real
                                        gracias a la sincronización en línea vía Internet. Tendrá acceso a:
                                    <ul>
                                        ...
                                        <li>Clasificación de clientes por rutas, sectores, días y secuencia de visita.
                                        </li>
                                        ...
                                        <li>Registro del inventario de productos del cliente eliminando el uso de
                                            tarjetas manuales.</li>
                                        <li>Facturación de combos.</li>
                                        <li>Actualización de información vía Internet.</li>
                                        <li>Impresión de documentos.</li>
                                        <li>Análisis de la efectividad de rutas y tiempos de visitas de los diferentes
                                            agentes.</li>
                                        <li>Geolocalización mediante Google Maps o Waze.</li>
                                    </ul>
                                    </p>
                                    <p class="custom-card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do
