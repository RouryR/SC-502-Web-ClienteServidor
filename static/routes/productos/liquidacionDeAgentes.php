                ...
                <div class="container mb80">
                    <div class="page-timeline">
                                    ...
                                    <div class="zoom-effect">
                                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php"
                                            ...
                                            <p><img class="custom-image"
                                                    src="/SC-502-Web-ClienteServidor/static/img/productos/liquidacion.jpg"
                                                    alt="ERP" /></p>
                                        </a>
                                    </div>
                                    <p class="custom-card-text">Este módulo brinda una herramienta para el proceso de
                                        liquidación de:
                                    <ul>
                        ...
                        <div class="vtimeline-point">
                            <div class="vtimeline-block">
                                <div class="vtimeline-content">
                                    <h3>Más de Liquidación de Agentes</h3>
                                    <p class="custom-card-text">"Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit, sed do
                                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                        veniam, quis
