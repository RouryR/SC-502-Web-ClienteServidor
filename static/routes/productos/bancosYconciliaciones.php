...
<head>
    <title>Bancos y Conciliaciones</title>
    ...
    <main>
        <div class="content-container">
            ...
            #2069AD; text-align: center; border-bottom: 1px solid black">
                    <i class="fa-solid fa-briefcase fa-beat fa-sm" style="color: #ffffff;"></i> Bancos y Conciliaciones
                </p>
                <div id="about-card" class="card text-center">
                    <p class="custom-card-text">Con dicho módulo su compañía podrá:
                    <ul>
                        <li>Administrar el registro de transacciones bancarias, conciliaciones bancarias así como el control de cheques devueltos y posfechados, control de entrega de cheques.</li>
                        <li>Consultar los saldos de las diferentes cuentas y estados de cuenta así como reportes de histórico.</li>
                        <li>Diferencial Cambiario.</li>
                    </ul></p>
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="/SC-502-Web-ClienteServidor/static/img/productos/bacos.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <div class="card-body">
