    ...
    <main>
        <div class="content-container">
            ...
            #2069AD; text-align: center; border-bottom: 1px solid black">
                    <i class="fa-solid fa-briefcase fa-beat fa-sm" style="color: #ffffff;"></i> Activos Fijos
                </p>
                <div id="about-card" class="card text-center">
                    <p class="custom-card-text">El control de activos nunca antes fue tan fácil con este módulo podrá:
                    <ul>
                        <li>Registrar todos los datos de los diferentes activos de la empresa.</li>
                        <li>Controlar el cálculo de la depreciación acumulada y el gasto de la depreciación diaria o mensual de los mismos.</li>
                        <li>Permite la consulta a reportes generales para el control del inventario valuado de activos, control de activos y mejoras.</li>
                    </ul></p>
                    ...
                    <div class="zoom-effect">
                        <a href="/SC-502-Web-ClienteServidor/static/routes/contactenos.php" id="popupLink">
                            <p><img class="custom-image" src="/SC-502-Web-ClienteServidor/static/img/productos/activos.jpg"
                                    alt="ERP" /></p>
                        </a>
                    </div>
                    <div class="card-body">
