                                    ...
                                    <div id="about-card" class="card text-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text"><img width="60" height="60"
                                                    src="https://img.icons8.com/ultraviolet/60/goal.png" alt="goal" />
                                                En
                                                <strong>Excalibur-Tech
                                                    S.A.</strong> somos una empresa líder en soluciones de tecnología de
                                                la información, ofreciendo
                                                un servicio de
                                                calidad del más alto nivel competitivo que garantiza a nuestros clientes
                                                la
                                                administración
                                                adecuada de
                                                su información.
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text"><img width="60" height="60"
                                                    src="https://img.icons8.com/office/60/define-location.png"
                                                    alt="define-location" /> En
                                                <strong>Excalibur-Tech S.A.</strong> buscamos ser un proveedor de
                                                servicios
                                                de
                                                tecnología de
                                                la información de primer
                                                nivel, que ayude
                                                a los clientes en el cumplimiento de sus objetivos mediante una
                                                herramienta
                                                flexible, amigable,
                                                poderosa
                                                y acorde a las
                                    ...
                                    <div id="about-card" class="card text-center">
                                        ...
                                        <div class="card-body">
                                            <div class="grid-container">
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/request-money.png"
                                                        alt="request-money" />
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/id-not-verified.png"
                                                        alt="id-not-verified" />
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/coins.png" alt="coins" />
                                                    <span>Comisiones</span>
                                                </div>

                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/accounting.png"
                                                        alt="accounting" />
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/withdrawal.png"
                                                        alt="withdrawal" />
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/color/48/move-by-trolley.png"
                                                        alt="move-by-trolley" />
                                                ...
                                                <div class="grid-item">
                                                    <img width="48" height="48"
                                                        src="https://img.icons8.com/windows/48/clipboard-list.png"
                                                        alt="clipboard-list" />
                                                ...
                                                <div class="grid-item mb-3">
                                                    <img width="50" height="50"
                                                        src="https://img.icons8.com/plasticine/50/truck--v1.png"
                                                        alt="truck--v1" />
                                                    <span>Compras</span>
                                                </div>
                                            </div>
                            ...
                            <div class="vtimeline-block">
                                <div class="vtimeline-content">
                                    <p
                                        ...
                                        <i class="fa-solid fa-thumbs-up fa-beat fa-sm" style="color: #ffffff;"></i>
                                        Casos de
                                        Éxito
                                    </p>
                                    <br>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/2.jpg"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/3.png"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/7.jpg"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/9.png"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/11.jpg"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/12.jpg"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/13.png"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/14.png"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                        ...
                                        <div class="col-sm-6 mb-5">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <img src="/SC-502-Web-ClienteServidor/static/img/CasosExito/15.png"
                                                        class="card-img-top" alt="...">
                                                    <i class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
                                                        class="fa-solid fa-star" style="color: #ffd500;"></i><i
