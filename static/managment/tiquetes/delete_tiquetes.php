...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id_tiquete'])) {
    ...
    if ($sentencia->execute()) {
        ...
        header("Location: /SC-502-Web-ClienteServidor/static/routes/managerpages/tiquetes/tiquetes.php?mensaje=Eliminado con éxito el tiquete&numero=$id_tiquete");
        exit();
    } else {
        header("Location: /SC-502-Web-ClienteServidor/static/routes/managerpages/tiquetes/tiquetes.php?mensaje=Error al eliminar");
        exit(); 
    }
